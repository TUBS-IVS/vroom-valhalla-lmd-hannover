...
# Restart Valhalla when memory exceeds this many MiB (host has 64 GB).
_VALHALLA_MEM_LIMIT_MB = 20_000

# Max successive container restarts before the solver gives up on a request.
