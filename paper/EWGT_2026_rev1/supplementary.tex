...
% and is reached either from paper/EWGT_2026_rev1/figures/ (first \graphicspath
% entry) or, for the five that 71_sync_paper_figs.py does not carry, through the
% relative path ../../results/revision_2026_08_v6/figures/ (second entry).
% 71_ RENAMES on sync: supp_fig4b_mean_days -> supp_fig4b_mean_delivery_days,
...
% supp_fig6b_operator_lens_v2 -> supp_fig6b_operator_lens_hub. The six synced
% files below use the DESTINATION names (md5-verified identical to the renders);
% supp_fig7_* and the four supp_map_*/supp_penalty_* use the source names and
% resolve through the relative path until 71_ carries them too.
%
