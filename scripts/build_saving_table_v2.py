...
Reads:
    results/final_optimization_v2/ml_vs_vroom_per_day.csv (per-day rows)
...
SRC = ROOT / "results" / "final_optimization_v2" / "ml_vs_vroom_per_day.csv"
OUT_DIR = ROOT / "results" / "final_optimization_v2" / "vroom_validation"
