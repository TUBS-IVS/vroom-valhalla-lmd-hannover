"""Precise read-off break-even plots, from tab_breakeven_per_cell.csv (no ML).
  ...
  fig_BE5_saving_heatmap_hubdist_share  median saving over hub-dist × share, annotated,
  ...
  fig_BE8_isosaving_contour             filled iso-saving contour over (share × hub-dist):
...
def main():
    ...
    # ── BE5: median-saving heatmap hub-dist × share ──────────────────────
    ...
    plt.close(fig); print("  ✓ fig_BE7")

    # ── BE8: iso-saving filled contour over (share × hub-dist) ───────────
