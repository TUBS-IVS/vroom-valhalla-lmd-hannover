...
def fig_pareto_clean(P, S, W):
    ...
    plt.close(fig); print("  ✓ fig_PF3b_pareto_clean")
...
def fig_knee_curve(P, S, W):
    ...
    plt.close(fig); print("  ✓ fig_PF4_knee_curve")
...
def fig_shadow_price(P, S, W):
    ...
    plt.close(fig); print("  ✓ fig_PF5_shadow_price")
...
def fig_provider_pareto():
    ...
    plt.close(fig); print("  ✓ fig_PF6_provider_pareto")
