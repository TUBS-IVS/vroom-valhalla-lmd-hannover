"""Fill in the empty sub-folders of paper_final_2026_05_28 with additional
...
def main():
    ...
    copies = [
        ...
        ("results/overnight_2026_05_27_balanced/fig_sweet_spot_math.png",
         "05_optimization/fig_O1_sweet_spot_math.png"),
        ("results/overnight_2026_05_27_balanced/fig_sweet_spot_math.pdf",
         "05_optimization/fig_O1_sweet_spot_math.pdf"),
        ("results/overnight_2026_05_27_balanced/tab_sweet_spot_data.csv",
    ...
    print(f"  ✓ 02_baseline/tab_daily_baseline_kpis.csv")
    ...
    if (OUT / "03_training" / "training_matrix.csv").exists():
        ...
        print(f"  ✓ 03_training/tab_training_summary.json")
        ...
        plt.close(fig)
        print(f"  ✓ 03_training/fig_T1_training_distribution.png")
    ...
    extras = [
        ...
        "* **fig_H4_residual_regime_heatmap**: residual % across (parcels × area) bins",
