...
def main():
    ...
    plt.close(fig); print("  ✓ fig_BE1 (corrected)")
    ...
    plt.close(fig); print("  ✓ fig_BE2 (corrected)")
    ...
    plt.close(fig); print("  ✓ fig_BE3 (corrected)")

    # BE4 corrected: hub_dist × area median-saving heatmap (bundled)
    op = op.copy()
    ...
    plt.close(fig); print("  ✓ fig_BE4 (corrected)")
