...
def fig_sm_optimized():
    ...
    plt.close(fig)
    print("  ✓ SM1b: schedule_mix_grid OPTIMIZED (init, no sweep)")
...
def fig_dt3_lgb_residual():
    ...
    print(f"  ✓ DT3: lgb_residual (R²={r2:.3f}, mean residual {lgb_residual_pct.mean():+.2f}%)")
    ...
    plt.close(fig)
    print("  ✓ H1: lgb_residual_distribution (new model)")
