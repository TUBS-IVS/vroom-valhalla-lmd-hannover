...
_deprecation_warnings.warn(
    "paper_final_cost_decomposition.py is a STALE entry point: it recomputes totals WITHOUT the pool "
...
def main():
    ...
    plt.close(fig); print("  [OK] fig_CD1_cost_composition")
    ...
    plt.close(fig); print("  [OK] fig_CD2_conventional_share")
