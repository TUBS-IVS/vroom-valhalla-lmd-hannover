...
_deprecation_warnings.warn(
    "paper_final_finegrid_production.py is a STALE entry point: it recomputes totals WITHOUT the pool "
...
def main():
    ...
    plt.close(fig)
    print("\n  [OK] fig_O8 regenerated (production pipeline)")
    ...
    plt.close(fig)
    print("  [OK] fig_O9 regenerated (production pipeline)")
