...
def main():
    ...
    plt.close(fig); print("  ✓ fig_BE3")

    # BE4: hub_dist × area median-saving heatmap at operating point
    op = op.copy()
    ...
    ax.set_title(f"Median saving by hub-distance × area  (P={OP_P:g}, share={OP_SHARE:.0%})")
